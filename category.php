...
<head>
    ...
    <title>Categoria | <?php echo $nombre ?></title>
    <!-- Favicon icon -->
            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="product.php">Categoria</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-primary" onclick="NuevoCategoria();"><i class="icon-plus"></i> Agregar Categoria</button>
                            </div>
                            <div class="card-body">
...
function NuevoCategoria(){
    MostrarModal(0, 'modal/nuevo_categoria.php');
}
...
function editarCategoria(id){
    //alert(id);
    MostrarModal(id, 'modal/nuevo_categoria.php');
}
