    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header"  style="background:<?php echo$color ?>;">
                <strong><h5 class="modal-title" id="myModalLabel" style="color:#fff"><i class='icon-pencil'></i> <?php echo $titulo; ?></h5></strong>
...
//                    }
                ...
                <button type="submit" class="btn btn-info" id="guardar_estudiante"><i class="bi bi-hdd-fill"></i> guardar categoria</button>
            </div>
