           ...
           <div class="modal-body">
                <form class="form-horizontal" method="post" id="guardar_usuario" name="guardar_usuario">
                  ...
                  <?php   }?>
                     ...
                     <div class="col-lg-6">
                    <div class="form-group">
                        <label for="Canton" class="col-control-label font-weight-bold Negrita">Tipo Usuario:</label>
                ...
                <button type="submit" class="btn btn-info " id="guardar_datos"><i class="bi bi-hdd-fill"></i> Guardar Usuario</button>
            </div>
