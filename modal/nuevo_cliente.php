...
<div class="col-lg-6">
                     ...
                     <div class="form-group">
                        <label for="Correo" class="col-control-label font-weight-bold Negrita"> Direccion:</label>
                            ...
                            <textarea type="text" minlength="8" id="Nombres" name="Direccion_txt" class="form-control" value="" required placeholder="ingrese su direccion"><?php echo $direccion; ?></textarea>
                        </div>    
                ...
                <button type="submit" class="btn btn-info" id="guardar_estudiante"><i class="bi bi-fill"></i> Guardar cliente</button>
            </div>
