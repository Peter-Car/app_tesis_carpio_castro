...
<head>
    ...
    <title>rango ventas | <?php echo $nombre ?> </title>
    <!-- Favicon icon -->
            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="ventas_rango.php">ventas rango</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                            ...
                            <form action="" method="post" id="consulta">
                                    <div class=" row col-12">
                                        <div class="form-group col-sm-3">
                                            ...
                                            <select name="condiciones" class="form-control" id="fecha">
                                                <option value="1">Ventadidos</option>
                                        ...
                                        <div class="form-group col-sm-3">
                                           <br>
                                        <button class="btn btn-primary"  id="consulta" ><i class="icon-plus"></i> Consultar ventas </button>
                                        </div>
                                    </div>
                                </form>
                            <div class="card-body">
...
$(document).ready(function(){
    listar('ajax/consultar_venta.php');
    //prueba();
});
function listar(url){
    $.ajax({
...
$(document).ready(function(){
    // capturar el valor del id que se recibe
     $('#consulta').bind("submit", function (){
       ...
       $.ajax({
           type: 'Post',
           url:'ajax/consultar_venta.php',
           data:$(this).serialize(),
           beforeSend: function() {
      $('#loading').show("Cargando..........."); // muestra el GIF de carga antes de la petición AJAX
         },
           success: function (data){
